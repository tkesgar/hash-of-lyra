...
export async function verify(
  ...
  function phcOutputToPHCStringInfo(
    phcOutput: import("@phc/format").PhcOutput,
  ): PHCStringInfo {
  ...
  if (typeof hash === "undefined") {
    throw new InvalidPHCStringError("PHC string does not have hash", {
      ...phcInfo,
      params: { ...phcInfo.params },
    });
  }

  const salt = phcInfo.salt;
  if (typeof salt === "undefined") {
    throw new InvalidPHCStringError(
      "PHC string does not have salt",
      phcOutputToPHCStringInfo(phcInfo),
    );
  }
  ...
  switch (phcInfo.id) {
    ...
    case "argon2d": {
      ...
      if (
        ...
        throw new InvalidPHCStringError(
          "Missing argon2 parameters from PHC string",
          phcOutputToPHCStringInfo(phcInfo),
        );
      }
    ...
    case "scrypt": {
      ...
      if (
        ...
        throw new InvalidPHCStringError(
          "Missing scrypt parameters from PHC string",
          phcOutputToPHCStringInfo(phcInfo),
        );
      }
    ...
    case "pbkdf2-sha512": {
      ...
      if (typeof i !== "number") {
        throw new InvalidPHCStringError(
          "Missing pbkdf2 parameters from PHC string",
          phcOutputToPHCStringInfo(phcInfo),
        );
      }
